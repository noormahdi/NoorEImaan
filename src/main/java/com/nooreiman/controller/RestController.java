...
public class RestController {
	...
	public @ResponseBody List<Ayat> getAllAyatsFromSurah(@PathVariable("id") long id) {
	...
	public @ResponseBody List<Translation> getAllTranslationsFromSurah(@PathVariable("id") long id) {
	...
	public @ResponseBody List<Translation> getAllTranslations() {
	...
	public @ResponseBody Translation getSpecificTranslationfromSurah(@PathVariable("surahid") long surahid,
			@PathVariable("ayatid") long ayatid) {
	...
	public @ResponseBody Ayat getSpecificAyatsfromSurah(@PathVariable("surahid") long surahid,
			@PathVariable("ayatid") long ayatid) {
		Ayat ayat = null;
		try {
	...
	public @ResponseBody Ayat getAyatByID(@PathVariable("id") long id) {
		Ayat ayat = null;
		try {
	...
	public @ResponseBody Surah getSurahByID(@PathVariable("id") long id) {
		Surah surah = null;
		try {
	...
	public @ResponseBody List<Surah> getallSurahs() {
	...
	public @ResponseBody List<Ayat> getAyats() {
	...
	public @ResponseBody Status deleteAyat(@PathVariable("id") long id) {
	...
	public @ResponseBody Status addAyat(@RequestBody Ayat ayat) {
		try {
